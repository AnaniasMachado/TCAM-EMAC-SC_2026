function [norma_gurobi,time_gurobi,H] = gurobi_MainFunctionP1P2P3(A,m,n)
t1 = tic;
...
set_prop = {'included','included','not included','not included','not included','not included','not included','not included','not included','not included','included'};
%%

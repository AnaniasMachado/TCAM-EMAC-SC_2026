function [norma_gurobi,time_gurobi,H] = gurobi_MainFunctionP1sym(A,m,n)
t1 = tic;
...
set_prop = {'included','not included','not included','not included','not included','not included','not included','not included','not included','included','not included'};
%%
